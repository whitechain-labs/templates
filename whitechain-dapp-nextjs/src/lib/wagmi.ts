...
// Public by design: it identifies the app to WalletConnect relays. This module
// is bundled into the browser, so never put a server secret here.
...
if (walletConnectEnabled) {
  ...
  createAppKit({
    ...
    projectId,
    networks,
    // Drops the Coinbase Wallet SDK from the bundle and the CSP allow-list.
