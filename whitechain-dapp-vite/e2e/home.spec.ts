...
// Example e2e test. Loads the SPA and asserts the dapp scaffold renders: the
// header plus the Wallet and Storage cards. The wallet connect flow itself needs
// a real wallet + Reown project id, so it's out of scope for a headless run.
