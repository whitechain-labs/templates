...
2. Copy `.env.example` to `.env` and fill in `VITE_REOWN_PROJECT_ID` (see [Environment](#environment)).
...
| ----------------------- | ------------------------------------------------------------------------------------------------- |
| `VITE_REOWN_PROJECT_ID` | Reown/WalletConnect project ID. Create one at [dashboard.reown.com](https://dashboard.reown.com). |
